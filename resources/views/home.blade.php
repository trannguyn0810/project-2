...
<div class="header-top">
    ...
    <div class="nav-item">
        ...
        <a href="{{ route('product.ad') }}" style="text-decoration: none; color: black;">Admin</a>
    </div>
    <div class="nav-item">
    ...
    <div class="nav-item cart-button" style=" background-color: red">
        ...
        <a href="{{ route('product.cart') }}" style="text-decoration: none; color: black;">Cart</a>
    </div>
</div>

<div style="background-color: #FFF2F2">
<div class="category-image">
    <img src="img/home.jpg" style="width:100%;height:100%;" alt=""/>
</div>
    <div style="text-align: center; font-size: 40px; margin-top: 50px" ><b>Lego nổi bật</b></div>
                ...
                <div class="col-md-3">
                    <div class="card custom-card">
                        <a href="{{ route('product.show', $product->id) }}">
                            <img src="{{ asset('img/lego/' . $product->image) }}" class="card-img-top" alt="{{ $product->product_name }}">
                        </a>
                        <div class="card-body">
    ...
    <div class="more" style="text-align: center">
        <button class="center-button"><a href="{{ route('home') }}" style="text-decoration: none; color: black">Xem thêm</a></button>
    </div>
